...
class GameController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        // $services['Client.TalkService'] = TalkService::class;
    ...
    // public static function testSubscribedServices()
    // {
    //     /** @var stdObject $services */
    //     $services = parent::getSubscribedServices();
    //     $services['Client.TalkService'] = TalkService::class;
    ...
    // /**
    //  * @Route("/gameWinner", name="gameWinner")
    //  */    
    // public function readyToGo(string $robotSelected, SluggerInterface $slugger): Response
    // {
    //     $robotSelected = $slugger->slug($robotSelected);
    ...
    //     $ginny = [
    //         'name' => 'Ginny', 'attack' => $attackGinny, 'img' => 'assets/images/weapons/' . $attackGinnyImg,
    //         'citation' => $ginnyCitations
    //     ];
    //     $percy = [
    //         'name' => 'Percy', 'attack' => $attackPercy, 'img' => 'assets/images/weapons/' . $attackPercyImg,
    ...
    //     $maps = ['photos'];
    //     // var_dump($robotWin["name"]);
    //     // var_dump($robotLose["name"]);
